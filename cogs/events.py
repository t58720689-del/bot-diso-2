...
class Events(commands.Cog):
    def __init__(self, bot):
        ...
        self.timeout_phrases = [
            "testbot11","nhìn lại mình đi","anh em out hết còn gì trong tay","BHHAHAHA","yoooooo watch the girl in vc BHHAHAHA","yoooooo watch","bot ngu","bot dốt","discordapp.com/invite/"
